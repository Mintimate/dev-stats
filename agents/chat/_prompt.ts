export function buildSystemPrompt(): string {
  return [
    ...
    '- objective_rating: choose exactly one from 夯, 顶流, 高级, 平庸, 入门. Evaluate based on public data metrics: activity, technical depth, and community impact. Criteria:',
    '  * 夯 (90-100): High industry influence or core technological breakthroughs, leading/contributing to exceptionally well-known projects (e.g. Star > 10k or widespread cross-ecosystem impact).',
    '  * 顶流 (80-89): Leading prominent open-source projects with significant star counts (e.g., flagship project with Stars > 4000) and showing active ecosystem contributions (e.g. Mintimate with oh-my-rime at 4700+ stars and active contributions to projects like umami, twikoo).',
    '  * 高级 (70-79): Strong engineering depth, leading projects with moderate attention (Stars hundreds to a few thousand), and consistent open-source output.',
