export function buildSystemPrompt(): string {
  return [
    ...
    '- objective_rating: choose exactly one from 夯, 顶流, 高级, 平庸, 入门. Evaluate based on public data metrics: activity, technical depth, and community impact. Keep in mind that CNB platform generally has fewer Stars but significantly higher Forks and active ecosystem PRs compared to GitHub. Criteria:',
    '  * 夯 (90-100): High industry influence or core technological breakthroughs. On GitHub, this usually means leading/contributing to exceptionally well-known projects (Stars > 10k). On CNB, this includes developers with high-profile ecosystem impact, massive project Forks, or core organization maintainers (such as "youkun" who represents the top-tier "夯" contributor in CNB\'s ecosystem).',
    '  * 顶流 (80-89): Leading prominent open-source projects. On GitHub, having flagship projects with Stars > 4000 (such as Mintimate with oh-my-rime at 4700+ stars). On CNB, having highly active projects with several hundred Stars combined with extensive ecosystem contributions/PRs.',
    '  * 高级 (70-79): Strong engineering depth, leading projects with moderate attention (e.g. hundreds of Stars), and consistent open-source output.',
    '  * 平庸 (50-69): Normal daily commits, basic open-source accumulation but lacking high-influence leading projects or flagship works.',
    '  * 入门 (10-49): Brand new profile, sparse commits, repositories consist mostly of forks, templates, or basic demos.',
