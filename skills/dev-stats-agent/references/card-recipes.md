...
- CNB language metadata reports detected languages and repository coverage, not source-byte proportions. Describe CNB language cards as coverage/frequency and do not claim code-size percentages.
